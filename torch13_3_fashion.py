...
def evaluate(model, criterion, loader):
    ...
    with torch.no_grad():
        for x_batch, y_batch in loader:
            ...
            acc_fin = (y_pred_label == y_batch).float().mean()
...
for epoch in range(1, epochs+1):
    ...
    print(f'epoch:{epoch}, loss:{loss:4f}, acc:{    epoch:4f}, \
...
# 최종 loss: tensor(0.0021, device='cuda:0')
# 최종 acc: tensor(0.0056, device='cuda:0')
