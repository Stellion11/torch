...
print(img_tensor.min(), img_tensor.max()) #tensor(0.) tensor(0.9765) #전처리 돼있음 확인
...
# print(model) # forward가 아닌 init 에 정의한게 나옴
...
summary(model, (32, 1, 56, 56)) # (batch_size, channels, )
...
# Normalize 전
# 최종 loss: 0.47010853681891873
# 최종 acc: tensor(0.8302, device='cuda:0')

# Normalize 후
# 최종 loss: 0.07393239373835875
# 최종 acc: tensor(0.9763, device='cuda:0')